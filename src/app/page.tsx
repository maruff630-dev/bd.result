    ...
    <div className="space-y-2 relative">
      ...
      <div className="relative">
        <div 
          ...
          className={`w-full bg-white border ${isOpen ? 'border-blue-500 ring-4 ring-blue-500/10' : 'border-slate-200'} rounded-2xl px-4 py-3.5 flex justify-between items-center cursor-pointer transition-all shadow-sm hover:border-slate-300`}
        >
          ...
          {isOpen && (
            <>
              ...
              <motion.div 
                ...
                className="absolute z-50 w-full mt-2 bg-white border border-slate-100 rounded-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] overflow-hidden"
              >
                  ...
                  {options.map((opt: any) => (
                    <div
                      ...
                      className={`px-4 py-2.5 rounded-xl cursor-pointer text-sm font-medium transition-all ${
                        value === opt.value ? 'bg-blue-50 text-blue-700' : 'text-slate-700 hover:bg-slate-50 hover:text-slate-900'
                      }`}
                    >
                      {opt.label}
                    </div>
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 sm:p-6 overflow-hidden bg-slate-50">
      {/* Background Orbs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[20%] -left-[10%] w-[60%] h-[60%] rounded-full bg-blue-500/10 blur-[120px]" />
        <div className="absolute top-[40%] -right-[10%] w-[60%] h-[60%] rounded-full bg-emerald-500/10 blur-[120px]" />
      </div>
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        >
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-blue-100 text-blue-700 font-semibold text-xs sm:text-sm mb-4 lg:mb-6">
              <Award size={16} className="sm:w-[18px] sm:h-[18px]" />
              অফিসিয়াল রেজাল্ট পোর্টাল
            </div>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 leading-tight mb-4 lg:mb-6 tracking-tight">
              বাংলাদেশ এডুকেশন <br className="hidden sm:block"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-500">বোর্ড রেজাল্ট</span>
            </h1>
          ...
          <div className="space-y-3 lg:space-y-4 w-full max-w-sm sm:max-w-md mx-auto lg:mx-0 text-left">
            <div className="flex items-center gap-3 sm:gap-4 text-sm sm:text-base text-slate-700 font-medium bg-white/50 p-3 sm:p-4 rounded-2xl border border-white shadow-sm lg:shadow-none">
        ...
        >
          <div className="bg-white/90 backdrop-blur-2xl border border-white p-6 sm:p-10 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    value={formData.roll}
                    onChange={handleChange}
                    className="w-full bg-white border border-slate-200 text-slate-800 placeholder-slate-400 rounded-2xl px-4 py-3.5 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-medium shadow-sm hover:border-slate-300"
                  />
                </div>
